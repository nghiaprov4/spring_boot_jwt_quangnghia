package com.example.spring_boot_jwt_quangnghia.util;
...
public class JwtUtil {
    ...
    private static final String USER = "thieuquangnghia";
    private static final String SECRET = "hey Mr Nghia the secrect length must be at least 256 bits" +
            " please no reveal!";
    ...
    public UserPrincipal getUserFromToken(String token) {
        ...
        try {
            ...
            if (claims != null && isTokenExpired(claims)) {
                JSONObject jsonObject =  (JSONObject) claims.getClaims();
